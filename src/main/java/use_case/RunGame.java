...
//            }
    ...
    public static void SwitchRandomPokemon(PlayerorAiPokemons playerorAiPokemons) {
    ...
    public static void SwitchPokemon(PlayerorAiPokemons playerorAiPokemons) {
        ...
        do {
            ...
            for (int i = 0; i < playerorAiPokemons.pokemons.length; i++)  {
                Pokemon pokemon = playerorAiPokemons.pokemons[i];
                if (pokemon.getIsAlive()) {
                    System.out.println(i + ": " + pokemon.getName() + " | Status: " + "Alive");
                } else {
                    System.out.println(i + ": " + pokemon.getName() + " | Status: " + "Fainted!");
                }
            }
    ...
    public void playMove(PlayerorAiPokemons player, PlayerorAiPokemons opponent) {
        ...
        while (continueMove) {
            ...
            switch (moveType) {
                ...
                default:
                    System.out.println("Invalid Move type. Please try again.");
                    break;
            }
        }
    }
